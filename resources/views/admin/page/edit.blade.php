...
<div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <br>
                                    <form method="post" action="/admin/page/update/{{$result['0']->id}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                              <input name="slug" value="{{$result['0']->slug}}"  type="text" class="form-control" placeholder="" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">description</label>
                                            <div class="col-sm-4">
                                                <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="3" > {{$result['0']->description}}</textarea>
                                            </div>
                                          </div>
